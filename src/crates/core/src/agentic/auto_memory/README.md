...
This module implements BitFun's background "auto extract memory" system.
...
while adapting to BitFun's persisted-turn architecture.
...
- [manager.rs](/E:/Projects/work/BitFun/src/crates/core/src/agentic/auto_memory/manager.rs)
  Workspace-level scheduler, queueing, and concurrency control.
- [types.rs](/E:/Projects/work/BitFun/src/crates/core/src/agentic/auto_memory/types.rs)
  Durable extraction cursor and throttle state.
- [prompt.rs](/E:/Projects/work/BitFun/src/crates/core/src/agentic/auto_memory/prompt.rs)
  Claude-like extractor prompt builder.
- [restrictions.rs](/E:/Projects/work/BitFun/src/crates/core/src/agentic/auto_memory/restrictions.rs)
  Runtime tool/path restrictions for the fork.
- [coordinator.rs](/E:/Projects/work/BitFun/src/crates/core/src/agentic/coordination/coordinator.rs)
  Turn-end trigger logic and fork execution.
- [session_manager.rs](/E:/Projects/work/BitFun/src/crates/core/src/agentic/session/session_manager.rs)
...
BitFun instead uses persisted dialog turns as the authoritative extraction
...
If the main agent already wrote workspace memory in that turn, BitFun follows
Claude's behavior:
...
BitFun computes it from the fork's inherited runtime context, not from a
